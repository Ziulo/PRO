Proceso Ejercicio15
	//16.	Igual al anterior, pero para un número de asignaturas también seleccionable por el usuario (máximo 10), 
	//es decir, se pedirán los nombres y x notas (lsa que haya dicho el usuario) para cada alumno y después 
