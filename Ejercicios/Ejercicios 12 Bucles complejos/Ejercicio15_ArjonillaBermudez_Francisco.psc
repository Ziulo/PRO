Proceso Ejercicio15
	//15.	Programa que permite solicitar y almacenar en memoria los nombres  y las nota de los alumnos de una clase 
	//(se preguntará al usuario cuantos alumnos hay en la clase ?como máximo podrán ser 100, debemos asegurarnos de ello), 
	//presentando después la lista de estos alumnos con su nota al lado, ordenador alfabéticamente.
